...
func createAccount(t time.Time, accountId, orgId uuid.UUID, bankId, bankIdCode string, bic bic.BankIdentifierCode) AccountWrapper {
...
func Test_accountClient_Create_ok(t *testing.T) {
	...
	bankId := "400300"
	bankIdCode := "GBDSC"
	bic := bic.BankIdentifierCode("NWBKGB22")
